...
public class InputAbstractor {
	...
	// That way, by modifying this class to use another lib than LWJGL, it makes it easy
	...
	public static void update(XolioWindow engine) {
		/*
		 * This part is about Keyboard/mouse events handling.
		 * It does be dependent of LWJGL.
		 */
