...
public class TileVillage extends TileConquerable{
	...
	public String[] getTooltip() {
		if(nation == -1)
			return new String[] {"Village","Free","Population : "+population};
		return new String[] {"Village","Nation : "+NationsInfo.getNation(nation),"Population : "+population};
	}
